...
class REFER:
    ...
    def __init__(self, data_root, dataset='refcoco', splitBy='unc'):
        self.dataset_split_by = dataset + '_' + splitBy
        ...
        self.data['refs'] = pickle.load(open(ref_file, 'rb'), encoding='latin1')
    ...
    def loadAnns(self, ann_ids=[]):
        ...
        elif type(ann_ids) == int or type(ann_ids) == str:  # change from `unicode` to `str`
